// src/main/java/com/example/studio_book/controller/AdminProfileController.java
...
public class AdminProfileController {
    ...
    public AdminProfileController(UserService userService) { this.userService = userService; }
